#############################################################################
# Makefile for building: fet
# Generated by qmake (1.07a) (Qt 3.3.2) on: Sat Sep 11 15:15:30 2004
# Project:  fet.pro
# Template: subdirs
# Command: $(QMAKE) -o Makefile fet.pro
#############################################################################
...
Makefile: fet.pro  /usr/lib/qt/mkspecs/default/qmake.conf 
	$(QMAKE) -o Makefile fet.pro
qmake: qmake_all
	@$(QMAKE) -o Makefile fet.pro
