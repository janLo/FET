...
{
	AddConstraintTeachersSubgroupsMaxHoursDailyForm *addConstraintTeachersSubgroupsMaxHoursDailyForm=new AddConstraintTeachersSubgroupsMaxHoursDailyForm();
	addConstraintTeachersSubgroupsMaxHoursDailyForm->exec();
...
void ConstraintTeachersSubgroupsMaxHoursDailyForm::modifyConstraint()
{
	...
	modifyConstraintTeachersSubgroupsMaxHoursDailyForm->exec();
