...
{
	AddConstraintBasicCompulsoryTimeForm *addConstraintBasicCompulsoryTimeForm=new AddConstraintBasicCompulsoryTimeForm();
	addConstraintBasicCompulsoryTimeForm->exec();
...
void ConstraintBasicCompulsoryTimeForm::modifyConstraint()
{
	...
	modifyConstraintBasicCompulsoryTimeForm->exec();
