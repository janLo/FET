...
{
	AddConstraintStudentsSetNotAvailableForm *addConstraintStudentsSetNotAvailableForm=new AddConstraintStudentsSetNotAvailableForm();
	addConstraintStudentsSetNotAvailableForm->exec();
...
void ConstraintStudentsSetNotAvailableForm::modifyConstraint()
{
	...
	modifyConstraintStudentsSetNotAvailableForm->exec();
