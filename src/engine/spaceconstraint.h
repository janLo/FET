...
enum SpaceConstraintType {
    ...
    CONSTRAINT_ACTIVITY_PREFERRED_ROOM								=1003,
    CONSTRAINT_ACTIVITY_PREFERRED_ROOMS								=1004,

    CONSTRAINT_STUDENTS_SET_HOME_ROOM								=1005,
    CONSTRAINT_STUDENTS_SET_HOME_ROOMS								=1006,

    CONSTRAINT_TEACHER_HOME_ROOM									=1007,
    CONSTRAINT_TEACHER_HOME_ROOMS									=1008,

    CONSTRAINT_SUBJECT_PREFERRED_ROOM								=1009,
    CONSTRAINT_SUBJECT_PREFERRED_ROOMS								=1010,
    CONSTRAINT_SUBJECT_ACTIVITY_TAG_PREFERRED_ROOM					=1011,
    CONSTRAINT_SUBJECT_ACTIVITY_TAG_PREFERRED_ROOMS					=1012,

    CONSTRAINT_STUDENTS_MAX_BUILDING_CHANGES_PER_DAY				=1013,
    CONSTRAINT_STUDENTS_SET_MAX_BUILDING_CHANGES_PER_DAY			=1014,
    CONSTRAINT_STUDENTS_MAX_BUILDING_CHANGES_PER_WEEK				=1015,
    CONSTRAINT_STUDENTS_SET_MAX_BUILDING_CHANGES_PER_WEEK			=1016,
    CONSTRAINT_STUDENTS_MIN_GAPS_BETWEEN_BUILDING_CHANGES			=1017,
    CONSTRAINT_STUDENTS_SET_MIN_GAPS_BETWEEN_BUILDING_CHANGES		=1018,

    CONSTRAINT_TEACHERS_MAX_BUILDING_CHANGES_PER_DAY				=1019,
    CONSTRAINT_TEACHER_MAX_BUILDING_CHANGES_PER_DAY					=1020,
    CONSTRAINT_TEACHERS_MAX_BUILDING_CHANGES_PER_WEEK				=1021,
    CONSTRAINT_TEACHER_MAX_BUILDING_CHANGES_PER_WEEK				=1022,
    CONSTRAINT_TEACHERS_MIN_GAPS_BETWEEN_BUILDING_CHANGES			=1023,
    CONSTRAINT_TEACHER_MIN_GAPS_BETWEEN_BUILDING_CHANGES			=1024,

    CONSTRAINT_ACTIVITY_TAG_PREFERRED_ROOM							=1025,
    CONSTRAINT_ACTIVITY_TAG_PREFERRED_ROOMS							=1026,

    CONSTRAINT_ACTIVITIES_OCCUPY_MAX_DIFFERENT_ROOMS				=1027,
    CONSTRAINT_ACTIVITIES_SAME_ROOM_IF_CONSECUTIVE					=1028
};
...
public:
	...
	*/
    SpaceConstraint(SpaceConstraintType const &constraintType, double wp);
