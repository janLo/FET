...
enum TimeConstraintType {
    ...
    CONSTRAINT_TEACHER_NOT_AVAILABLE_TIMES							=3,
    CONSTRAINT_TEACHERS_MAX_HOURS_DAILY								=4,
    CONSTRAINT_TEACHER_MAX_DAYS_PER_WEEK							=5,
    CONSTRAINT_TEACHERS_MAX_GAPS_PER_WEEK							=6,
    CONSTRAINT_TEACHER_MAX_GAPS_PER_WEEK							=7,
    CONSTRAINT_TEACHER_MAX_HOURS_DAILY								=8,
    CONSTRAINT_TEACHERS_MAX_HOURS_CONTINUOUSLY						=9,
    CONSTRAINT_TEACHER_MAX_HOURS_CONTINUOUSLY						=10,

    CONSTRAINT_TEACHERS_MIN_HOURS_DAILY								=11,
    CONSTRAINT_TEACHER_MIN_HOURS_DAILY								=12,
    CONSTRAINT_TEACHERS_MAX_GAPS_PER_DAY							=13,
    CONSTRAINT_TEACHER_MAX_GAPS_PER_DAY								=14,

    CONSTRAINT_STUDENTS_EARLY_MAX_BEGINNINGS_AT_SECOND_HOUR			=15,
    CONSTRAINT_STUDENTS_SET_EARLY_MAX_BEGINNINGS_AT_SECOND_HOUR		=16,
    CONSTRAINT_STUDENTS_SET_NOT_AVAILABLE_TIMES						=17,
    CONSTRAINT_STUDENTS_MAX_GAPS_PER_WEEK							=18,
    CONSTRAINT_STUDENTS_SET_MAX_GAPS_PER_WEEK						=19,

    CONSTRAINT_STUDENTS_MAX_HOURS_DAILY								=20,
    CONSTRAINT_STUDENTS_SET_MAX_HOURS_DAILY							=21,
    CONSTRAINT_STUDENTS_MAX_HOURS_CONTINUOUSLY						=22,
    CONSTRAINT_STUDENTS_SET_MAX_HOURS_CONTINUOUSLY					=23,

    CONSTRAINT_STUDENTS_MIN_HOURS_DAILY								=24,
    CONSTRAINT_STUDENTS_SET_MIN_HOURS_DAILY							=25,

    CONSTRAINT_ACTIVITY_ENDS_STUDENTS_DAY							=26,
    CONSTRAINT_ACTIVITY_PREFERRED_STARTING_TIME						=27,
    CONSTRAINT_ACTIVITIES_SAME_STARTING_TIME						=28,
    CONSTRAINT_ACTIVITIES_NOT_OVERLAPPING							=29,
    CONSTRAINT_MIN_DAYS_BETWEEN_ACTIVITIES							=30,
    CONSTRAINT_ACTIVITY_PREFERRED_TIME_SLOTS						=31,
    CONSTRAINT_ACTIVITIES_PREFERRED_TIME_SLOTS						=32,
    CONSTRAINT_ACTIVITY_PREFERRED_STARTING_TIMES					=33,
    CONSTRAINT_ACTIVITIES_PREFERRED_STARTING_TIMES					=34,
    CONSTRAINT_ACTIVITIES_SAME_STARTING_HOUR						=35,
    CONSTRAINT_ACTIVITIES_SAME_STARTING_DAY							=36,
    CONSTRAINT_TWO_ACTIVITIES_CONSECUTIVE							=37,
    CONSTRAINT_TWO_ACTIVITIES_ORDERED								=38,
    CONSTRAINT_MIN_GAPS_BETWEEN_ACTIVITIES							=39,
    CONSTRAINT_SUBACTIVITIES_PREFERRED_TIME_SLOTS					=40,
    CONSTRAINT_SUBACTIVITIES_PREFERRED_STARTING_TIMES				=41,

    CONSTRAINT_TEACHER_INTERVAL_MAX_DAYS_PER_WEEK					=42,
    CONSTRAINT_TEACHERS_INTERVAL_MAX_DAYS_PER_WEEK					=43,
    CONSTRAINT_STUDENTS_SET_INTERVAL_MAX_DAYS_PER_WEEK				=44,
    CONSTRAINT_STUDENTS_INTERVAL_MAX_DAYS_PER_WEEK					=45,

    CONSTRAINT_ACTIVITIES_END_STUDENTS_DAY							=46,

    CONSTRAINT_TWO_ACTIVITIES_GROUPED								=47,

    CONSTRAINT_TEACHERS_ACTIVITY_TAG_MAX_HOURS_CONTINUOUSLY			=48,
    CONSTRAINT_TEACHER_ACTIVITY_TAG_MAX_HOURS_CONTINUOUSLY			=49,
    CONSTRAINT_STUDENTS_ACTIVITY_TAG_MAX_HOURS_CONTINUOUSLY			=50,
    CONSTRAINT_STUDENTS_SET_ACTIVITY_TAG_MAX_HOURS_CONTINUOUSLY		=51,

    CONSTRAINT_TEACHERS_MAX_DAYS_PER_WEEK							=52,

    CONSTRAINT_THREE_ACTIVITIES_GROUPED								=53,
    CONSTRAINT_MAX_DAYS_BETWEEN_ACTIVITIES							=54,

    CONSTRAINT_TEACHERS_MIN_DAYS_PER_WEEK							=55,
    CONSTRAINT_TEACHER_MIN_DAYS_PER_WEEK							=56,

    CONSTRAINT_TEACHERS_ACTIVITY_TAG_MAX_HOURS_DAILY				=57,
    CONSTRAINT_TEACHER_ACTIVITY_TAG_MAX_HOURS_DAILY					=58,
    CONSTRAINT_STUDENTS_ACTIVITY_TAG_MAX_HOURS_DAILY				=59,
    CONSTRAINT_STUDENTS_SET_ACTIVITY_TAG_MAX_HOURS_DAILY			=60,

    CONSTRAINT_STUDENTS_MAX_GAPS_PER_DAY							=61,
    CONSTRAINT_STUDENTS_SET_MAX_GAPS_PER_DAY						=62,

    CONSTRAINT_ACTIVITIES_OCCUPY_MAX_TIME_SLOTS_FROM_SELECTION		=63,
    CONSTRAINT_ACTIVITIES_MAX_SIMULTANEOUS_IN_SELECTED_TIME_SLOTS	=64,

    CONSTRAINT_STUDENTS_SET_MAX_DAYS_PER_WEEK						=65,
    CONSTRAINT_STUDENTS_MAX_DAYS_PER_WEEK							=66
};
